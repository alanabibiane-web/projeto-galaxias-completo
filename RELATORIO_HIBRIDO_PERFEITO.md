...
### Ajuste de de Vaucouleurs
![Ajuste de de Vaucouleurs](NGC4473_vaucouleurs_analise.png)
*Ajuste de de Vaucouleurs - Resultado do ajuste fotométrico.*
...
- `dados_NGC5846_completo.csv` - Tabela completa de isofotas
- `dados_NGC4473_completo.csv` - Tabela completa de isofotas  
- `parametros_estruturais.txt` - Parâmetros derivados
- `dados_relatorio_completos.json` - Dados compilados em JSON

## APÊNDICE B - CATÁLOGO DE FIGURAS
- **NGC 5846 com isofotas ajustadas** (*arquivo não gerado*)
- **NGC 4473 com isofotas ajustadas** (*arquivo não gerado*)
- **Perfis de brilho superficial** (*arquivo não gerado*)
- **Ajuste de de Vaucouleurs** (`NGC4473_vaucouleurs_analise.png`)
- **Modelo e resíduos** (*arquivo não gerado*)
- **Identificação do centro** (*arquivo não gerado*)

## APÊNDICE C - METODOLOGIA DETALHADA
O processo de análise incluiu:
1. **Aquisição**: Download de imagens FITS do SDSS DR8
2. **Preprocessamento**: Identificação de centro e corte de regiões
3. **Ajuste**: Algoritmo iterativo de ajuste elíptico de isofotas
4. **Análise**: Cálculo de perfis de brilho e ajuste de de Vaucouleurs
5. **Validação**: Análise de resíduos e qualidade do ajuste
